  ...
  <form id="inputForm" action="${pageContext.request.contextPath }/category/save.do" method="post">
	...
	<tr>
		...
		<td><input type="text" name="categoryName" size="40" maxlength="20"
			value="${category.categoryName}" id="categoryName" class="easyui-validatebox" required="true" validType="length[2,20]" readonly="readonly"/></td>
	</tr>
	<tr>
		<td>展示名称<span class="required">(*)</span></td>
		<td><input type="text" name="showName" size="40" maxlength="20"
			value="${category.showName}" class="easyui-validatebox" required="true" validType="length[2,20]" readonly="readonly"/></td>
	</tr>
	<tr>
