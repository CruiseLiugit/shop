...
$("<a href=\"javascript:void(0)\" class=\"datebox-clear\"></a>").html(_4.clearText).appendTo(_9);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(_4.closeText).appendTo(_9);

_9.find(".datebox-current,.datebox-clear,.datebox-close").hover(function(){
...
//清空
_9.find(".datebox-clear").click(function(){
	alert($(_2));
	$(_2).val("");
});
//关闭
...
_a(this,q);
}},currentText:"Today",closeText:"Close",clearText:"清空",okText:"Ok",formatter:function(_1b){
