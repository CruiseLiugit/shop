...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,30,50,100],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_76,_77){
...
//新增-点击输入框事件
$(_751).parent().click(function(){
	$(_751).combo("showPanel");
});
...
$("<a href=\"javascript:void(0)\" class=\"datebox-clear\"></a>").html(opts.clearText).appendTo(_756);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_756);
_756.find(".datebox-current,.datebox-clear,.datebox-close").hover(function(){
...
//新增-清空功能
_756.find(".datebox-clear").click(function(){
	_759(_751,"");
	$(_751).combo("hidePanel");
});
...
_757(this,q);
}},currentText:"Today",closeText:"Close",clearText:"清空",okText:"Ok",formatter:function(date){
